...
public class LocalStatAction extends HTSLImpl {
    ...
    public LocalStatAction() {
        super("Local Stat Action");
        this.statName = "Kills";

        this.statInstances.add(new StatInstance("local"));
    }
    ...
    public String toString() {
        ...
        return "LocalStatAction (StatName: " + statName + ", StatInstances: " + sb.toString() + ")";
    }

    @Override
    public void createDisplayItem(ItemBuilder builder) {
        builder.material(Material.LIGHTNING_ROD);
        builder.name("&eChange Local Stat");
    ...
    public void createAddDisplayItem(ItemBuilder builder) {
        builder.material(Material.LIGHTNING_ROD);
        builder.name("&aChange Local Stat");
    ...
    public ActionEditor editorMenu(HousingWorld house, Menu backMenu) {
        if (backMenu == null) {
            return new ActionEditor(6, "&eLocal Stat Action Settings");
        }
        ...
        items.add(new ActionEditor.ActionItem(
            ...
            statInstances.add(new StatInstance("local"));
            backMenu.open();
            return true;
        }
        ));
    ...
    public void fromData(HashMap<String, Object> data, Class<? extends Action> actionClass) {
        ...
        if (data.containsKey("statInstances")) {
            ...
            StatInstance statInstance = new StatInstance("local");
    ...
    public ArrayList<String> importAction(String action, String indent, ArrayList<String> nextLines) {
        ...
        StatInstance instance = new StatInstance("local");
