...
public class GroupProperty extends PaginationProperty<Group> {
    public GroupProperty(String id, String name, String description) {
        super(id, name, description, Material.WHITE_BANNER);
    }

    @Override
    protected List<Group> getItems(HousingWorld house) {
        return house.getGroups();
    }

    @Override
    protected ItemBuilder buildItem(Group item) {
