...
public class LocalStatRequirementCondition extends CHTSLImpl implements NPCCondition {
    private String stat;
    private StatComparator comparator;
    private String compareValue;
    private boolean ignoreCase;

    public LocalStatRequirementCondition() {
        super("Local Stat Requirement");
        this.stat = "Kills";
    ...
    public String toString() {
        return "LocalStatRequirementCondition";
    }
    ...
    public ActionEditor editorMenu(HousingWorld house) {
        ...
        return new ActionEditor(4, "Local Stat Requirement", items);
    }
    ...
    public boolean execute(Player player, HousingWorld house, Cancellable event, ActionExecutor executor) {
        String statName = HandlePlaceholders.parsePlaceholders(player, house, this.stat);
        Stat stat = executor.getLocalStat(statName);
        if (stat == null) {
            stat = new Stat(statName, "0");
        }
    ...
    public String export(int indent) {
        ...
        return "localstat " + stat + " " + comparator.name() + " " + compareValue + " " + ignoreCase;
    }
