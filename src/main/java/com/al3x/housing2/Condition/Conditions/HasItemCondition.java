        ...
        List<ActionEditor.ActionItem> items = Arrays.asList(
                new ActionEditor.ActionItem("item",
                        ItemBuilder.create(Material.BOOK)
                                .name("&eItem")
                                .info("&7Current Value", "")
                                .info(null, "&a" + (item == null ? "&aNot Set" : item.getItemMeta().getDisplayName()))
                ...
                new ActionEditor.ActionItem("whereToCheck",
                        ItemBuilder.create(Material.BOOK)
                                ...
                                .info("&7Current Value", "")
                                .info(null, "&a" + StringUtilsKt.formatCapitalize(whereToCheck.name()))
                                .lClick(ItemBuilder.ActionType.CHANGE_YELLOW),
                        ActionEditor.ActionItem.ActionType.ENUM, WhereToCheck.values(), null
                ),
