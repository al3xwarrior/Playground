...
public class CancelAction extends Action {
    ...
    public List<EventType> allowedEvents() {
        return Arrays.asList(FISH_CAUGHT, PLAYER_ENTER_PORTAL, PLAYER_BLOCK_BREAK, PLAYER_BLOCK_PLACE, PLAYER_DROP_ITEM, PLAYER_PICKUP_ITEM, PLAYER_TOGGLE_FLIGHT, PLAYER_CHAT);
    }
